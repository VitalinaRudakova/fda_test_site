...
$vcan_site->onErrorData = "Ошибка изменения количества товара";
encodeArr($_GET);
encodeArr($_POST);
echo($vcan_site->execute('exec=КэнСайтПродажиСервер.КорзинаПокупателяИзменитьКоличествоНоменклатуры(ПараметрыЗапроса)'));
?>
